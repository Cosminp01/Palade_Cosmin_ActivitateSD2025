...
//}
//
//void adaugareVacantaStiva(Nod** varf, Vacanta vacantaNoua) {
//
...
//		adaugareVacantaStiva(varf, vacantaNoua);
//	}
//	fclose(file);
//}
//
...
//}
//
//void stergereVacantaStiva(Nod** varf, int idCautat) {
//
//	if (*varf != NULL && (*varf)->infoUtil.idVacanta == idCautat) {
//		Nod* temp = *varf;
//		*varf = (*varf)->next;
//		if (temp->infoUtil.destinatie != NULL) {
//			free(temp->infoUtil.destinatie);
...
//	stergereVacantaStiva(&varf, 10);
//	afisareStiva(varf);
//
//	printf("\n-----Afisare STIVA DEZALOCATA!------\n");
